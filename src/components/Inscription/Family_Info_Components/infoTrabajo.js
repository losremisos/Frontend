            ...
            <div style={{textAlign: "left" }}>
              <h4>Información Laboral</h4>
                ...
                <div className="row" >
                      <div className="col-md-3">
                              <div className="control-group">
                                    <label for="PTipoVia">Tipo de vía (<span className="field-required">*</span>):</label>
                                    <select name="PTipoVia" title="Tipo de Via Residencia Padre" className="form-control" tabIndex="1">
                                      <option selected="selected" value="-1">Seleccione...</option>
                      ...
                      <div className="col-md-3">
                              <div className="control-group">
                                <label for="PNombreVia1">Nombre o número de vía (<span className="field-required">*</span>):</label>
                                <input name="PNombreVia1" type="text" maxlength="50" id="PNombreVia1" title="Nombre o número de vía1 Padre" className="form-control" tabIndex="2" />  
                                <span id="ctl00_MainContent_reqDocumentNumber" className="field-validation-error" >&nbsp;&nbsp;&nbsp;</span>
                              </div>
                      </div>
                      <div className="col-md-3">
                              <div className="control-group">
                                    ...
                                    <select name="PComplementoVia1" title="Complemento vía principal Padre" className="form-control" tabIndex="1">
                                      <option selected="selected" value="-1">Seleccione...</option>
                      ...
                      <div className="col-md-3">
                              <div className="control-group">
                                <label for="PNombreVia2">Número de vía (<span className="field-required">*</span>):</label>
                                <input name="PNombreVia2" type="text" maxlength="50" id="PNombreVia2" title="Nombre o número de vía2 Padre" className="form-control" tabIndex="2" />  
                                <span id="ctl00_MainContent_reqDocumentNumber" className="field-validation-error" >&nbsp;&nbsp;&nbsp;</span>
                              </div>
                      </div>
                  </div>
                  ...
                  <div className="col-md-3">
                              <div className="control-group">
                                    ...
                                    <select name="PComplementoVia2" title="Complemento vía secundaria Padre" className="form-control" tabIndex="1">
                                      <option selected="selected" value="-1">Seleccione...</option>
                                      <option value="100000001">Este</option>
                                      <option value="100000002">Manzana</option>
                                      <option value="100000003">Noreste</option>
                    ...
                    <div className="col-md-3">
                            <div className="control-group">
                             ...
                             <input name="PNumeroCasa" type="text" maxlength="50" id="secTxtName" title="Numero de casa Padre" className="form-control" />
                             <span >&nbsp;&nbsp;&nbsp;</span>
                            </div>
                    </div>
                    <div className="col-md-3">
                              <div className="control-group">
                                    ...
                                    <select name="PComplemento" title="Complemento Padre" className="form-control" tabIndex="1">
                                      <option selected="selected" value="-1">Seleccione...</option>
                                      <option value="100000001">Este</option>
                                      <option value="100000002">Manzana</option>
                                      <option value="100000003">Noreste</option>
                    ...
                    <div className="col-md-3">
                            <div className="control-group">
                              <label for="PBarrio">Barrio o Vereda (<span className="field-required">*</span>):</label>
                              <input name="PBarrio" type="text" maxlength="50" id="PBarrio" title="Barrio o vereda Padre" className="form-control" />
                              <span >&nbsp;&nbsp;&nbsp;</span>
                            </div>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-md-12">
                            <div className="control-group">
                              ...
                              <input name="PDirecciónR" readonly="readonly" type="text" maxlength="50" id="txtPDateN" title="Dirección de Residencia Padre" className="form-control" />
                              <span >&nbsp;&nbsp;&nbsp;</span>
                            </div>
                    </div> 
                  </div>
